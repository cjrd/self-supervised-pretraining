...
export shortname="coco_2014_hires"
...
export train_val_combined_list_path="/home/cjrd/data/coco_2014/train_val.txt"

# the list of images just for training (used for the linear evaluation)
# NEEDS labels
export train_list_path="/home/cjrd/data/coco_2014/train.txt"
# the list of images just for training (used for val on the linear evaluation)
# NEEDS labels
export val_list_path="/home/cjrd/data/coco_2014/val.txt" 
# the list of images just for training (used for test on the linear evaluation)
# NEEDS labels
export test_list_path="/home/cjrd/data/coco_2014/test.txt" 
