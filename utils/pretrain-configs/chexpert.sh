...
export pixel_means="0.5028, 0.5028, 0.5028"
export pixel_stds="0.2919, 0.2919, 0.2919"
...
export train_val_combined_list_path="data/chexpert/meta/train-val.txt"

# the list of images just for training (used for the linear evaluation)
# NEEDS labels
export train_list_path="data/chexpert/meta/train-labeled.txt"
# the list of images just for training (used for val on the linear evaluation)
# NEEDS labels
export val_list_path="data/chexpert/meta/val-labeled.txt"
# the list of images just for training (used for test on the linear evaluation)
# NEEDS labels
export test_list_path="data/chexpert/meta/test-labeled.txt"

# the base data path that the image lists reference
export base_data_path="data/chexpert"
...
export basetrain_weights=(
        ...
        "data/basetrain_chkpts/imagenet_r50-21352794.pth"
...
export num_classes="5" # eg 10 for cifar-10
