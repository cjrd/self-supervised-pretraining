...
export pixel_means="0.368, 0.381, 0.3436"
export pixel_stds="0.2035, 0.1854, 0.1849"
...
export train_val_combined_list_path='data/resisc45/meta/train-val.txt'
# the list of images just for training (used for the linear evaluation)
export train_list_path="data/resisc45/meta/train-labeled.txt"
# the list of images just for training (used for val on the linear evaluation)
export val_list_path="data/resisc45/meta/val-labeled.txt"
# the list of images just for training (used for test on the linear evaluation)
export test_list_path="data/resisc45/meta/test-labeled.txt"
# the base data path that the image lists reference
export base_data_path="data/resisc45"
...
export basetrain_weights=(
        ...
        "data/basetrain_chkpts/mocoV2_200ep_resnet18.pth"

        # supervised basetrain
        "data/basetrain_chkpts/imagenet_r18_supervised.pth"
...
export num_classes="45" # eg 10 for cifar-10
...
export ft_num_train_labels="1000,all" # do 100 and 1000 label finetune evaluation
