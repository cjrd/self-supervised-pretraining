...
export shortname="resisc-ucmerced"
...
export pixel_means="0.4842,0.4901,0.4505"
export pixel_stds="0.2180,0.2021,0.1958"
...
export train_val_combined_list_path="data/ucmerced/meta/train_val_combined_repeat.txt"

# the list of images just for training (used for the linear evaluation)
# NEEDS labels
export train_list_path="data/ucmerced/meta/train_labeled_repeat.txt"
# the list of images just for training (used for val on the linear evaluation)
# NEEDS labels
export val_list_path="data/ucmerced/meta/val_labeled.txt"
# the list of images just for training (used for test on the linear evaluation)
# NEEDS labels
export test_list_path="data/ucmerced/meta/test_labeled.txt"

# the base data path that the image lists reference
export base_data_path="data/ucmerced"
...
export num_classes="21" # eg 10 for cifar-10
