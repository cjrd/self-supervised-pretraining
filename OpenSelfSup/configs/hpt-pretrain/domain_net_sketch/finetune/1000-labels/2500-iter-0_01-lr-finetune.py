...
data_train_list = "data/domain_net_sketch/meta/train_labeled-1000.txt"
data_train_root = 'data/domain_net_sketch'

data_val_list = "data/domain_net_sketch/meta/val_labeled.txt"
data_val_root = 'data/domain_net_sketch'

data_test_list = "data/domain_net_sketch/meta/test_labeled.txt"
data_test_root = 'data/domain_net_sketch'

dataset_type = "ClassificationDataset"
img_norm_cfg = dict(mean=[0.8327, 0.8270, 0.8179], std=[0.2727, 0.2753, 0.2810])
