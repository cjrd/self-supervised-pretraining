...
data_train_list = "data/domain_net_painting/meta/train_labeled-1000.txt"
data_train_root = 'data/domain_net_painting'

data_val_list = "data/domain_net_painting/meta/val_labeled.txt"
data_val_root = 'data/domain_net_painting'

data_test_list = "data/domain_net_painting/meta/test_labeled.txt"
data_test_root = 'data/domain_net_painting'

dataset_type = "ClassificationDataset"
img_norm_cfg = dict(mean=[0.5743, 0.5466, 0.5083], std=[0.3088, 0.3007, 0.3168])
