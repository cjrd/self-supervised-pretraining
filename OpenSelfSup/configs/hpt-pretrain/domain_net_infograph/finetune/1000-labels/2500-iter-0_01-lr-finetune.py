...
data_train_list = "data/domain_net_infograph/meta/train_labeled-1000.txt"
data_train_root = 'data/domain_net_infograph'

data_val_list = "data/domain_net_infograph/meta/val_labeled.txt"
data_val_root = 'data/domain_net_infograph'

data_test_list = "data/domain_net_infograph/meta/test_labeled.txt"
data_test_root = 'data/domain_net_infograph'

dataset_type = "ClassificationDataset"
img_norm_cfg = dict(mean=[0.6888, 0.6970, 0.6648], std=[0.3331, 0.3094, 0.3281])
