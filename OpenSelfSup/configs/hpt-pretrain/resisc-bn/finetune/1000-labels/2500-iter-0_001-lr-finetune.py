...
data_train_list = "data/resisc45/meta/train-labeled-1000.txt"
data_train_root = 'data/resisc45'

data_val_list = "data/resisc45/meta/val-labeled.txt"
data_val_root = 'data/resisc45'

data_test_list = "data/resisc45/meta/test-labeled.txt"
data_test_root = 'data/resisc45'
