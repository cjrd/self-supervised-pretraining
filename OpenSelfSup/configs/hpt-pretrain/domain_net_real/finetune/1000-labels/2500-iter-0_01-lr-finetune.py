...
data_train_list = "data/domain_net_real/meta/train_labeled-1000.txt"
data_train_root = 'data/domain_net_real'

data_val_list = "data/domain_net_real/meta/val_labeled.txt"
data_val_root = 'data/domain_net_real'

data_test_list = "data/domain_net_real/meta/test_labeled.txt"
data_test_root = 'data/domain_net_real'

dataset_type = "ClassificationDataset"
img_norm_cfg = dict(mean=[0.6059, 0.5890, 0.5558], std=[0.3344, 0.3279, 0.3493])
